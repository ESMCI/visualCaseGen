...
class GUI():
    ...
    def init_prelim_configvar_widgets(self):
    ...
    def display(self):
        ...
        self.init_prelim_configvar_widgets()
        ...
        vCIME = widgets.Accordion(
            children=[self.GUI_preliminaries(), cv_create_tab.widget],
            titles=('Slider', 'Text')
        )
