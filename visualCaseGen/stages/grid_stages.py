...
def initialize_grid_stages(cime):
    ...
    stg_mesh_mask_modifier = Stage(
        ...
        "mesh_mask_modifier tool. Firstly, an input mask mesh file containing an initial "
        "land mask must be provided. If found, this will be auto-filled to a default mesh path. "
        ...
        "manes of latitude and laongitude in the mask file. Finally, specify the output file name "
        "to be generated by the mesh_mask_modifier tool.",
        widget=StageWidget(VBox),
        parent=stg_mesh_mask_modifier_branch,
        varlist=[cvars["INPUT_MASK_MESH"]],
    )
