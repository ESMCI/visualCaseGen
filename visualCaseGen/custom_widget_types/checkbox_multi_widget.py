...
class CheckboxMultiWidget(widgets.VBox, HasTraits):
    ...
    def __init__(self, value=None, options=None, description='', disabled=False, allow_multi_select=True):
    ...
    def _display_options(self, options_list=None):
        ...
        self._options_hbox.children = tuple([
            widgets.VBox(self._options_widgets_display, layout={'max_width':_checkbox_clm_width,
